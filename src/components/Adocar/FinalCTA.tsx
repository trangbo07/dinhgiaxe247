  ...
  return (
    <section className="relative w-full bg-gradient-to-b from-white to-slate-50 py-28 overflow-hidden text-center border-t border-slate-100">
      ...
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[250px] bg-emerald-500/5 rounded-full blur-[100px] animate-pulse" style={{ animationDuration: '6s' }} />
      </div>
      ...
      <div className="container relative z-10 mx-auto px-4 max-w-4xl">
        <motion.span 
          ...
          viewport={{ once: true }}
          className="text-xs font-bold text-emerald-700 uppercase tracking-widest bg-emerald-50 border border-emerald-200/50 px-4 py-1.5 rounded-full"
        >
        ...
        >
          <Link 
            href="/#valuation" 
            className="rounded-xl bg-gradient-to-r from-emerald-500 to-cyan-500 hover:opacity-90 px-8 py-3.5 font-bold text-slate-950 shadow-md hover:shadow-emerald-500/20 transition-all hover:scale-105"
          >
            Định Giá Xe AI
          </Link>
          <Link 
