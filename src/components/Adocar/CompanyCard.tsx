  ...
  return (
    <section id="contact" className="relative w-full bg-white py-24 overflow-hidden border-t border-slate-100">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-1/4 right-10 h-72 w-72 rounded-full bg-blue-600/5 blur-[100px]" />
      </div>

      <div className="container relative mx-auto px-4 z-10">
        <div className="text-center max-w-3xl mx-auto mb-16">
          <span className="text-xs font-bold text-blue-600 uppercase tracking-widest bg-blue-50 border border-blue-200/50 px-4 py-1.5 rounded-full backdrop-blur-md">
            Đồng Hành Cùng Bạn
          </span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          >
            <div>
              ...
              <div className="space-y-3.5 text-sm text-slate-600 border-t border-slate-100 pt-6">
                ...
                <div className="flex items-center gap-3">
                  <span className="text-blue-500">🌐</span>
                  <span><strong>Website:</strong> <Link href="/" className="text-blue-600 hover:underline font-medium">dinhgiaxe247.vn</Link></span>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8 pt-6 border-t border-slate-100 flex flex-wrap items-center justify-between gap-4">
              <div className="text-xs text-slate-500">
                <span className="text-primary font-bold text-sm"><Counter to={15840} />+</span> người dùng tin cậy
              </div>
              <div className="flex gap-2">
                <a
                  href="tel:0859968686"
                  className="h-10 px-4 rounded-xl bg-primary hover:bg-blue-700 text-white font-semibold text-xs flex items-center justify-center transition-all duration-200"
                >
                  Gọi Hotline
                </a>
                <Link
          ...
          >
            <div>
              <div className="flex justify-between items-start mb-6">
                <div>
                  ...
                  <p className="text-xs text-blue-600 font-bold uppercase tracking-wider mt-1">Dịch vụ thuê xe điện VinFast</p>
                </div>
                <div className="px-3 py-1 rounded-full bg-blue-50 border border-blue-200/60 text-blue-600 text-xs font-bold">
                  Green Mobility
                </div>
              ...
              <div className="space-y-3.5 text-sm text-slate-600 border-t border-slate-100 pt-6">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span><strong>Facebook:</strong> <a className="text-blue-600 hover:underline font-medium" target="_blank" rel="noreferrer" href="https://www.facebook.com/profile.php?id=100064330291919">Fanpage AdoCar</a></span>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8 pt-6 border-t border-slate-100 flex flex-wrap items-center justify-between gap-4">
              <div className="text-xs text-slate-500">
                <span className="text-primary font-bold text-sm"><Counter to={1280} />+</span> khách hàng đồng hành
              </div>
              <div className="flex gap-2">
                <a
                  href="tel:0787866999"
                  className="h-10 px-4 rounded-xl bg-primary hover:bg-blue-700 text-white font-bold text-xs flex items-center justify-center transition-all duration-200"
                >
                  Gọi Hotline
                </a>
                <a
